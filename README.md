...
[Passmarked](http://passmarked.com?source=github&repo=css) is a suite of tests that can be run against any page/website to identify issues with parity to most online tools in one package.
